    ...
    <main id="main" class="page">
      ...
      <template v-if="summary && !loading">
        ...
        <section v-else-if="state.view === 'status'" class="panel">
          ...
          <p v-for="recorded in status?.recorded_reports || []" :key="recorded.context">
          ...
          <p v-if="!(status?.recorded_reports || []).length">
            No collector or initialization checks have been recorded yet, so source and cloud
            access is unverified here.
          </p>
